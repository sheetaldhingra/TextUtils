...
export default function About(props) {
  ...
  <div className="accordion-item">  
    ...
    <div id="collapseOne" style={props.myStyle} className="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
  ...
  <div className="accordion-item">
    ...
    <div id="collapseTwo" style={props.myStyle} className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
      <div className="accordion-body">
  ...
  <div className="accordion-item">
    ...
    <div id="collapseThree" style={props.myStyle} className="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
      <div className="accordion-body">
